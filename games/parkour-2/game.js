...
const levelNames = {
  1: "Паркур 2: Башни",
  2: "Паркур 2: Ветер",
  3: "Паркур 2: Неоновые Лица",
  4: "Паркур 2: Огненные Веревки",
  5: "Паркур 2: Космический Лед",
};
...
function makeLevel(n) {
  const base = {
    ...
    angle: 0,
    shake: 0,
    width: n === 5 ? 5200 : n === 4 ? 5000 : n === 2 ? 4700 : n === 3 ? 4200 : 4300,
    checkpoint: { x: 90, y: 450 },
    p: { x: 90, y: 450, r: 22, vx: n === 2 ? 375 : 0, vy: 0, a: 0, ground: false, coyote: 0, dash: 0, lives: n === 2 ? 5 : n === 4 ? 4 : n === 5 ? 4 : 4, rope: null },
    coins: [],
    platforms: [],
    hazards: [],
    ropes: [],
...
function update(dt) {
  ...
  if (p.x > finishX) {
    ...
    else transition(0, "Паркур 2 пройден. Искорка победила новую трассу.");
  }
